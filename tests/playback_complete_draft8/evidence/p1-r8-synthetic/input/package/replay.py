#!/usr/bin/env python3
"""Offline replay of hash-bound corrected P1-R8 evidence."""
...
def main():
    ...
    try:
        m=json.loads((ev/"manifest.json").read_text()); oracle.req(m.get("schema")=="playback-complete-draft8-evidence-v1","evidence schema"); oracle.req(m.get("assignment")=="P1-R8-V","assignment")
