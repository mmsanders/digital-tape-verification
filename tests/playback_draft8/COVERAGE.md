...
|---|---|---|---|
| PB8-A01 | Exact issued spec bytes, fixture archive/raw, metadata and candidate PCM hashes authenticate | `VERSION`; WP-11 | spec/fixture/PCM tamper |
...
| PB8-A11 | Offline replay authenticates every evidence file before recomputing exact verdict | WP-11 | missing/tampered evidence |
