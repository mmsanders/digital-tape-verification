...
| Build fault-injecting block device | Complete | `tests/fault_block_device.[ch]` is allocation-free C99, works inside multi-block writes, separates working/durable media, models flush and power cut, and persists torn prefixes. |
